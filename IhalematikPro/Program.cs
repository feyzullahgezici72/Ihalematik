...
namespace IhalematikPro
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            CurrentManager.Instance.CurrentOffer = OfferProvider.Instance.GetItem(1); //OfferProvider.Instance.GetItems().OrderByDescending(p => p.InsertTime).First();//.LastOrDefault();
